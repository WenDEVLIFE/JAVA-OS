...
public class soundsettings extends JDialog {
	...
	public static void main(String[] args) {
		try {
			...
			soundsettings dialogvol = new soundsettings();
	 ...
	 */
	public soundsettings() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
		setTitle("SOUND SETTINGS");
		soundsettings dialogvol = this;
		...
		JLabel lblNewLabel_1 = new JLabel("VOLUME SETTINGS");
		lblNewLabel_1.setFont(new Font("Dialog", Font.BOLD, 25));
		lblNewLabel_1.setBounds(179, 73, 397, 51);
		contentPanel.add(lblNewLabel_1);
		
		JSlider slider = new JSlider();
		slider.setOrientation(SwingConstants.VERTICAL);
		slider.setBackground(new Color(192, 192, 192));
		slider.setBounds(213, 210, 73, 217);
		contentPanel.add(slider);
		
		JLabel lblNewLabel_1_1_1_1 = new JLabel("SYSTEM VOLUME");
		lblNewLabel_1_1_1_1.setFont(new Font("Dialog", Font.BOLD, 19));
		lblNewLabel_1_1_1_1.setBounds(172, 144, 183, 51);
		contentPanel.add(lblNewLabel_1_1_1_1);
		
		JLabel lblNewLabel_1_1_1_1_1 = new JLabel("MIC VOLUME");
		lblNewLabel_1_1_1_1_1.setFont(new Font("Dialog", Font.BOLD, 19));
		lblNewLabel_1_1_1_1_1.setBounds(410, 144, 183, 51);
		contentPanel.add(lblNewLabel_1_1_1_1_1);
		
		JSlider slider_1 = new JSlider();
		slider_1.setOrientation(SwingConstants.VERTICAL);
		slider_1.setBackground(Color.LIGHT_GRAY);
		slider_1.setBounds(410, 210, 73, 217);
