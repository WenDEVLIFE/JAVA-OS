...
public class RESTART extends JFrame {
	 ...
	 */
	public RESTART() throws ClassNotFoundException, InstantiationException, IllegalAccessException, IOException, UnsupportedLookAndFeelException, InterruptedException {
		setTitle("CAT_OS");
